...
def minpath_wrapper(sample_id, strat_input, minpath_map, out_dir,
    ...
    path2minpath = path.join("/home/peterbock/Desktop/picrust/pipeline/picrust2", 'MinPath',
                                 'MinPath12hmp.py')
    minpath_cmd = path2minpath + " -any " + minpath_in + " -map " +\
                  minpath_map + " -report " + minpath_report +\
                  " -details " + minpath_details

    call(minpath_cmd.split(), shell=True)
...
file = "/home/peterbock/Desktop/picrust/pipeline/picrust2/tests/test_data/run_minpath/test_metagenome_out.tsv"
file = "/home/peterbock/Desktop/picrust/pipeline/picrust2/KO_metagenome_out/pred_metagenome_strat.tsv"
strat_in = read_strat_genes(file)

samples = [col for col in strat_in.columns
               if col not in ["function", "sequence"]]

sample1 = strat_in[["function","sequence", samples[0]]]

unstrat_input = strat_to_unstrat_counts(sample1)

mapFile = "/home/peterbock/Desktop/picrust/pipeline/picrust2/default_files/pathway_mapfiles/metacyc_path2rxn_struc_filt_pro.txt"

minpath_wrapper(samples[0],sample1,mapFile, "/home/peterbock/Desktop/testing_Minpath")
