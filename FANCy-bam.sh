...
# normalization -> "tss" for Total Sum Scaling, "uqs" for Upper Quartile Scaling, any other value for no scaling.
>>>>>>> ef34c62b7b029974176483d533d7ac09597eed28
...
snakemake -s $snake --config tango="$SCRIPTPATH" cur_dir="$SCRIPTPATH" bamdir="$bamDir"  output="$out" log="$log" ncbiDB="$taxa" pval="$pval" matchfiles="$match" metadata="$meta" option="$option" uniteDB="$db" GRP1="$grp1" GRP2="$grp2";
